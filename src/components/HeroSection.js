          ...
          <div className="container">
            ...
            >
              ...
              <h2 className=" text-1xl mt-10 font-light tracking-tight text-black-900 sm:text-2xl">
                ...
                is a symphony of freshness, quality, and a subtle hint of
                citrusy happiness, beautifully orchestrated to delight your
                senses.
              </h2>
            </div>
          </div>

          <div className="mt-6 ml-16 flex items-center justify-center gap-x-6">
            <button
              href="#"
