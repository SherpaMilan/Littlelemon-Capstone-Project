...
import myImage from "../images/logo6.jpg";
...
export default function HeroSection() {
  ...
  return (
    <div className="bg-white">
      <header className="absolute bg-indigo-90 inset-x-0 mt-[-190px]  z-50 ">
        <nav
        ...
        >
          ...
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5  p-1.5">
              ...
              <img
                className="h-25 w-25  contrast-125 brightness-75"
                src={myImage}
                alt="little lemon"
              />
            </a>
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-xl font-semibold hover:bg-gray-500  rounded-md px-3 py-2 text-black leading-6 text-gray-900"
              >
                {item.name}
              </a>
            ))}
      ...
      <div
        className="relative  isolate px-6 mt-20 pt-8 lg:px-8"
        style={{
      ...
      >
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto ml-90 max-w-2xl py-32 sm:py-48 lg:py-56">
