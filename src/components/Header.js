...
export const Header = () => {
  return (
    <Disclosure as="nav" className="bg-orange-350">
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current
                            ? "bg-gray-200 text-black font-bold" // Adjusted text color and added font weight
                            : "text-black-600 hover:bg-gray-300 hover:text-gray-800",
